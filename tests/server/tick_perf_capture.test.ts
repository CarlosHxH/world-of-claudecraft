...
describe('tick perf capture lifecycle', () => {
  ...
  it('registers the 29 base lap names first, then the 13 mob-family buckets', () => {
    ...
    expect(SIM_LAP_PHASES.slice(0, 29)).toEqual(base);
    expect(SIM_LAP_PHASES.slice(29)).toEqual(buckets);
