...
export const SURFACE_INVENTORY: readonly SurfaceRoute[] = [
  ...
  // v0.20.0 release merge: the housekeeping (game-config override) family, a
  // post-auth sub-dispatcher (handleHousekeepingApi) the handleAdminApi ladder
  // delegates to by prefix; migrated in-merge as 10 RouteDefs whose one shared
  // handler calls that sub-dispatcher whole (parity by construction). In-family
  // unknown sub-paths 404 and non-GET/POST 405 inside the sub-dispatcher on both
  // dispatch arms.
  {
    dispatcher: DISPATCH.admin,
    method: 'GET',
    path: '/admin/api/housekeeping/overview',
    handler: 'handleHousekeepingApi arm: /admin/api/housekeeping/overview',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleHousekeepingApi arm: /admin/api/housekeeping/rates',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  ...
  },
  {
    ...
    handler: 'handleHousekeepingApi arm: /admin/api/housekeeping/quests',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleHousekeepingApi arm: /admin/api/housekeeping/items',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleHousekeepingApi arm: /admin/api/housekeeping/npcs',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleHousekeepingApi arm: /admin/api/housekeeping/spawns',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleHousekeepingApi arm: /admin/api/housekeeping/world',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleHousekeepingApi arm: /admin/api/housekeeping/overrides',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
  },
  {
    ...
    handler: 'handleHousekeepingApi arm: /admin/api/housekeeping/overrides/clear',
    contentType: PROBLEM_JSON,
    authScope: AUTH_SCOPE.admin,
    limiter: null,
    requireOwnedExpected: null,
