...
//
// `IWorld` (src/world_api.ts, 184 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (184 / 49 / 135)
...
// The 184 members of `interface IWorld`, in interface order (world_api.ts).
// Partition: 49 `data` + 135 `method` (read-returning + command-void + async).
...
//   (4) their union, sorted, equals the pinned 184-name IWORLD_MEMBERS set (a member
